...
if(kolOptions>selectOrCombobox)
{
	...
	// для уникальности id элементов селектов используется num - порядковый номер селекта на странице
        //увеличил z-index с 1-num до 10-num - некорректно работали селекты при количестве >2
	jQuery(this).before("<div class='selectArea "+className+"' style='z-index:"+(10-num)+"'>"+
